...
Ralio.prototype.createTask = function (projectName, storyID, taskName, callback) {
  var self = this;
...
Ralio.prototype.deleteTask = function (projectName, storyID, taskName, callback) {
  var self = this;
...
Ralio.prototype.task = function (option, projectName, storyID, taskName, callback) {
  switch(option){
    case "create": this.createTask(projectName, storyID, taskName, callback); break;
    case "delete": this.deleteTask(projectName, storyID, taskName, callback); break;
  }
};
